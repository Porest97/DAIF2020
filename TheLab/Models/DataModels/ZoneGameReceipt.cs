...
namespace DAIF2020.TheLab.Models.DataModels
{
    public class ZoneGameReceipt
    {
        ...
        // Receipt ZoneGame Prop !
        [Display(Name = "Zone Game")]
        public int? ZoneGameId { get; set; }
        [Display(Name = "Zone Game")]
        [ForeignKey("ZoneGameId")]
        public ZoneGame ZoneGame { get; set; }
        ...
        [DataType(DataType.Currency)]
        public int UDZ1LateGameKost { get; set; } = 0;
        [Display(Name = "Other")]
        [DataType(DataType.Currency)]
        ...
        [DataType(DataType.Currency)]
        public int ZoneGameTotalKost { get; set; } = 0;
